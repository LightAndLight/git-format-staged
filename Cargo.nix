...
let
  nixifiedLockHash = "10552299556323094a3f818bb39feb551ec94dc169a4e3a6bf13a35fba8ceefd";
...
in
{
  ...
  workspace = {
    git-format-staged = rustPackages.unknown.git-format-staged."0.1.0";
  };
  ...
  "unknown".git-format-staged."0.1.0" = overridableMkRustCrate (profileName: rec {
